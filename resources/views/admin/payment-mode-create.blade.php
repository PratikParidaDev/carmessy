<div class="dashboard-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="margin: 0; font-size: 18px;">Create New Payment Mode</h2>
    ...
    <form action="{{ route('admin.payment-modes.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" 
                          ...
                          name="description" 
                          rows="3"
                          placeholder="Optional description for this payment mode">{{ old('description') }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save me-1"></i> Create Payment Mode
            </button>
            <a href="{{ route('admin.payment-modes') }}" class="btn btn-secondary">
                Cancel
            </a>
