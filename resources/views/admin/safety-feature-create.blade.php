        ...
        <div style="max-width: 600px;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input 
                    ...
                    placeholder="e.g., ABS, EBD, Airbags"
                />
                @error('name')
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea 
                    ...
                    rows="3"
                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;"
                    placeholder="Optional description of this safety feature"
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input 
                    ...
                    value="{{ old('icon') }}" 
                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;"
                    placeholder="e.g., fas fa-shield-alt (for safety features)"
                />
            ...
            <div style="margin-top: 30px;">
                <button type="submit" class="btn btn-primary" style="padding: 12px 24px; font-size: 16px;">
                    <i class="fas fa-save"></i> Create Safety Feature
                </button>
